...
public class Program {
	...
	public static void main(String[] args) {
		...
		Map<String, List<Pessoa>> pessoasPorCargo2 = ConsultaPessoas
				.obterPessoasPorCargo(List.of(pessoa1, pessoa4, pessoa10));
		Map<String, List<Pessoa>> pessoasPorCargo3 = ConsultaPessoas.obterPessoasPorCargo(List.of(pessoa4, pessoa9));
